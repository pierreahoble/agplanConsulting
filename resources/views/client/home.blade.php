...
<style type="text/css">div.image {max-width: 256px;max-height: 256px;background-image: url(data:image/svg+xml;base64,)}</style>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active">
                ...
                <!-- Single Slider -->
                <div class="single-slider slider-heights d-flex align-items-center">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="entrepreneuriat">Entrepreneuriat</a></h5>
                                <p>Désigne l'action d'entreprendre, de mener à bien un projet. Souvent
                                     utilisé dans le secteur des affaires, le terme entreprendre signifie créer une activité (économique) pour atteindre un objectif, répondre à un besoin.
                                     Le créateur représente l'entrepreneur, soit le porteur du projet.</p>
                                <a href="entrepreneuriat" class="read-more1">En savoir plus ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="douane">Transit Douane</a></h5>
                                <p>Le transit est un régime douanier, économique et suspensif qui permet à des marchandises de circuler d'un bureau de douane à un autre sur le même territoire ; d'un pays à un autre en 
                                    suspension des droits et taxes de douanes et des mesures de prohibition.
                                </p>
                                <a  href="douane" class="read-more1">En savoir plus ></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="assets/img/gallery/popular_sub4.png" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
                                    <h4><a href="#">Entrepreneuriat</a></h4>
                                </div>
                                ...
                                <div class="course-cap-bottom d-flex justify-content-between">
                                    ...
                                    <span>Free</span> --}}
                                     <a href="entrepreneuriat" class="btn">En savoir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="assets/img/gallery/popular_sub5.png" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
                                    <h4><a href="#">Transit Douane</a></h4>
                                </div>
                                <div class="course-cap-mid d-flex justify-content-between">
                                ...
                                <div class="course-cap-bottom d-flex justify-content-between">
                                    ...
                                    <span>Free</span> --}}
                                     <a href="douane" class="btn">En savoir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="single-course mb-40">
                            <div class="course-img">
                                <img src="assets/img/gallery/popular_sub6.png" alt="">
                            </div>
                            <div class="course-caption">
                                <div class="course-cap-top">
                                    <h4><a href="#">Immobilier</a></h4>
                                </div>
                                <div class="course-cap-mid d-flex justify-content-between">
                                    {{-- <div class="course-ratting">
                                        <i class="fas fa-star"></i>
                                ...
                                <div class="course-cap-bottom d-flex justify-content-between">
                                    ...
                                    <span>Free</span> --}}
                                     <a href="immobilier" class="btn">En savoir plus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <div class="section-tittle mb-35">
                                ...
                                <h2>Vouloir en savoir davantage</h2>
                            </div>
                            <p>
                            Il existe de nombreuses variantes de passages de sorem gpsum ilable, mais la majorité ont subi une altération 
                            sous une forme ou une autre, par humour ecté ou par mots aléatoires.
                            </p>
                            <ul>
