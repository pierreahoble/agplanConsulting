@extends('client.element',['titre'=>'Contact'])
...
@section('baniere')
        ...
        <div class="slider-area ">
            <div class="slider-heightconta d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Entrer votre adresse email'" placeholder="Entrer votre adresse Email">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <input class="form-control" name="subject" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Entrer Sujet'" placeholder="Entrer Sujet">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>05BP:321 Lome -Togo</h3>
                            <p>Lycée Agoè-Est à 800m de l'Eglise Catholique d'Agoè-Nyivé</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>(+228) 90 54 07 07 </h3>
                            <h3>(+228) 99 45 88 99</h3>
                            <p>Du lundi au vendredi de 7h à 18h</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-email"></i></span>
                        <div class="media-body">
                            <h3>agplanconsulting@gmail.com</h3>
