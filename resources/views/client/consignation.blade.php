@extends('client.element',['titre'=>'Consignation'])
...
@section('baniere')
        ...
        <div class="slider-area ">
            <div class="slider-heightconsignation d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2 text-center">
                                <h2 style="color: blue">Consignation</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="properties__button mb-90">
                            ...
                            <nav>                                                                             
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Tous nos Consignation</a>
                                </div>
                            </nav>
                            <!--End Nav Button  -->
                        </div>
