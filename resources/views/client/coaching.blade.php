@extends('client.element',['titre'=>'Coaching'])


@section('baniere')
	
        <div class="slider-area ">
            <div class="slider-heightcoaching d-flex align-items-center">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                        ...
                        <div class="properties__button mb-90">
                            ...
                            <nav>                                                                             
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Tous nos Coaching</a>
                                </div>
                            </nav>
                            <!--End Nav Button  -->
                        </div>
